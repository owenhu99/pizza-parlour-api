...
def test_check_inputs():
    drink = Drink('coke', 'small')
    assert drink.check_inputs('coke', 'small') == True
    assert drink.check_inputs('pepsi', 'medium') == True
    assert drink.check_inputs('invalid', 'small') == False
    assert drink.check_inputs('coke', 'invalid') == False
